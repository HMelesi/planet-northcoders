class mainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.anims.create({
      key: "lizz_left",
      frames: this.anims.generateFrameNumbers("lizz_run", {
        start: 12,
        end: 17,
      }),
      frameRate: 10,
    ...
    this.anims.create({
      key: "lizz_idle",
      frames: this.anims.generateFrameNumbers("lizz_idle", {
        start: 0,
        end: 5,
      }),
      frameRate: 10,
  ...
  update() {
    if (this.person && this.person.active) {
      ...
      if (
        ...
        (x !== this.person.oldPosition.x || y !== this.person.oldPosition.y)
      ) {
